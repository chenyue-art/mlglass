...
# Rem
data = data[~pd.isna(data['ND300'])]

columns_to_drop = ['Tg', 'Tliquidus']
...
final.to_csv('../../data/clean/data_ND300_names_dupl_rem.csv', index=False)
final.iloc[:, 1:].to_csv('../../data/clean/data_ND300_dupl_rem.csv', index=False)
